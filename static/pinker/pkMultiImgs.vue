<template>
  <div class="pad">
    <div class="form-box">
      <div class="no-img" v-if="!imgArr.length">点击左下角上传图片(可多选)</div>
    ...
    <div @click="deleteAll" class="del-all text-danger">删除全部</div>
  </div>
</template>
<style scoped>
  .pad{
...
export default {
  ...
  data() {
    return {
      ...
      upload_validate_str: localStorage.getItem("upload_validate_str")
    }
  },
  methods: {
    fileChange(e) {
