...
<div>
	<div class="col-sm-9">
    	...
    	<pk-input sm="6" label="地址">
    		<input type="text" class="form-control" v-on:keyup.enter="searchByStationName()" v-model="data.address" name="">
    	...
    	<pk-input sm="6" label="电话 021-">
    		<input type="text" class="form-control" v-model="data.tel" name=""></input>
    	</pk-input>  
...
import shopInfo from "./shopInfo"
	export default{
		...
		methods:{
			...
			searchByStationName(str){
			    window.map.clearOverlays();//清空原来的标注
			    let keyword = str ? str : this.searchStr + this.data.address;
